...
<div class="w-full max-w-md space-y-3">
    ...
    <a href="#" id="sortLink" class="pl-10 pr-4 py-2 w-full inline-block text-center border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-400 focus:border-red-400 transition">Sort</a>
