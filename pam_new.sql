...
insert  into `maintenance_table`(`id`,`name`,`is_closed`) values (1,'Procurements',1),(2,'Purchase Order',1),(4,'Report Generation',0),(5,'Account Settings',0),(6,'Assets',1),(8,'Inventory',0),(9,'Receive Logs',0);
